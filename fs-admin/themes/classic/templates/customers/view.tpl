<div class="row">
   ...
   <div class="col-8">
      <div class="card card-navy card-outline direct-chat direct-chat-primary">
         <div class="card-header">
            <div class="row">
               <div class="col-6">
                  ...
                  <div class="direct-chat-text">
                     {if !empty($m['img'])}
                        <div style="display: flex;">
                           <div>
                              <a href="{IMG_URI}m/{$m['img']}" target="_blank">
                                 <img src="{IMG_URI}m/{$m['img']}" style="width: 8rem; height: auto;">
                              </a>
                           </div>
         ...
         <div class="card-footer">
            <form class="form-ajax" method="post"
               target="{Tools::baseUrl()}?controller=AdminCustomers&action=send&token={Tools::getValue('token')}">
