         ...
         <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
               <a class="nav-link" data-toggle="dropdown" href="#">
                  <span class="pr-1">
                     <span class="badge badge-info text-bold navbar-badge"
                        style="border-radius:5px;top:0px;right:2px">15</span>
                     <i class="fas fa-bell" style="font-size: 1.1em;"></i>
                  </span>
               </a>
               <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right"
                  style="border-radius:20px;min-width:30rem">
                  <span style="padding: .5rem 1rem;display: flex;align-items: center;justify-content: left;"
                     class="text-bold"> Notifications</span>
                  <div class="dropdown-divider"></div>
                  <a href="#" class="dropdown-item" style="border-left:2px solid forestgreen">
                     <i class="fas fa-envelope mr-2"></i>
                     <span class="text-bold">4 new messages</span>
                     <br>
                     <span class="text-secondary">has been read!.</span>
                  ...
                  <div class="dropdown-divider"></div>
                  <a href="#" style="padding: .5rem 1rem;display: flex;align-items: center;justify-content: center;">See
                     All Notifications</a>
               </div>
            </li>
            <li class="nav-item dropdown">
